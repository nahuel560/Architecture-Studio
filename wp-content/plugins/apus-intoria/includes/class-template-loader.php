...
class Apus_Intoria_Template_Loader {
	 ...
	 * @throws Exception
	 */
	public static function locate( $name, $plugin_dir = APUS_INTORIA_PLUGIN_DIR ) {
		$template = '';

		$theme_folder_name = apply_filters( 'apus-intoria-theme-folder-name', 'apus-intoria' );
	 ...
	 * @throws Exception
	 */
	public static function get_template_part( $name, $args = array(), $plugin_dir = APUS_INTORIA_PLUGIN_DIR ) {
...
Apus_Intoria_Template_Loader::init();