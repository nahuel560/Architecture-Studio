...
?>
<section id="main-container" class="main-content home-page-default <?php echo apply_filters('intoria_blog_content_class', 'container');?> inner">
	...
	<div class="row">
		...
		<div id="main-content" class="col-sm-12 <?php echo esc_attr($sidebar_configs['main']['class']); ?>">
			...
			<?php if ( have_posts() ) : ?>
				...
				<?php
				$layout = intoria_get_config( 'blog_display_mode', 'list' );
