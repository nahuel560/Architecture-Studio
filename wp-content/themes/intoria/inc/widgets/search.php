...
class Intoria_Search extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'intoria'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'intoria' ), )
        );
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Intoria_Search');
}