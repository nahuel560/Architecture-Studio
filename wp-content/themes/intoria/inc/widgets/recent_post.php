...
class Intoria_Recent_Post extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_recent_post',
            esc_html__('Apus Recent Posts Widget', 'intoria'),
            array( 'description' => esc_html__( 'Show list of recent post', 'intoria' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>">
                <?php echo esc_html__('Type:', 'intoria' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'intoria' ); ?></label>
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Intoria_Recent_Post');
}