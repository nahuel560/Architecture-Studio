...
class Intoria_Socials_Widget extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_socials_widget',
            esc_html__('Apus Socials', 'intoria'),
            array( 'description' => esc_html__( 'Socials for website.', 'intoria' ), )
        );
    ...
    public function scripts() {
        wp_enqueue_script( 'intoria-script-admin-js', get_template_directory_uri().'/js/admin/admin.js', array( 'jquery' ), APUS_FRAMEWORK_VERSION, true );
    }
    ...
    <div class="apus_socials">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'socials' )); ?>"><?php esc_html_e('Select socials:', 'intoria'); ?></label>
            <br>
        <?php
...
if ( function_exists('apus_framework_reg_widget') ) {
    apus_framework_reg_widget('Intoria_Socials_Widget');
}